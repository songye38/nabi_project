          ...
          <View style={{flexDirection:'column',flex:1}}>
            ...
            <View style={{flex:1}}>
                <ScrollableTabView
                    ...
                    initialPage={0}>
                      <CommActivityList dataset = {this.state.onGoingResult} status = {this.state.joinStatus} key={'1'} tabLabel={`진행중 (${this.state.goingLen})`} style={{flex:1,backgroundColor:'red'}} navigation={this.props.navigation}  type ='ongoing' isActive={this.state.isSceneOneVisible}/>
                      <CommActivityList dataset = {this.state.participateResult} status = {1} key={'2'} tabLabel={`참여 (${this.state.takeLen})`} style={{flex:1,backgroundColor:'red'}} navigation={this.props.navigation} type = 'take' isActive={this.state.isSceneTwoVisible}/>
                      <CommActivityList dataset = {this.state.archiveResult} status = {1} key={'3'} tabLabel={`아카이브 (${this.state.archiveLen})`} style={{flex:1,backgroundColor:'red'}} navigation={this.props.navigation} type = 'archive' isActive={this.state.isSceneThreeVisible}/>
                </ScrollableTabView>
            </View>
            <Snackbar
              visible={this.state.visible}

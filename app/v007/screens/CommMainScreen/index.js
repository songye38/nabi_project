          ...
          <View style={{flexDirection:'column',flex:1}}>
            ...
            <View style={{flex:1}}>
                <ScrollableTabView
                    ...
                    initialPage={0}
                    >
                      <CommActivityList key={'1'} tabLabel={'진행중(10)'} style={{flex:1,backgroundColor:'red'}} navigation={this.props.navigation}/>
                      <CommActivityList key={'2'} tabLabel={'참여(30)'} style={{flex:1,backgroundColor:'red'}} navigation={this.props.navigation}/>
                      <CommActivityList key={'3'} tabLabel={'아카이브(60)'} style={{flex:1,backgroundColor:'red'}} navigation={this.props.navigation}/>

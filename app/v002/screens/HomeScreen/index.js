    ...
    render(){
        ...
        return (
            <View style={styles.container}>
                <TouchableHighlight style={styles.pointBox} onPress={() => navigate('PointScreen')} underlayColor='#eee'><Text style={styles.pointText}>{this.state.userPointData[0][2]} 포인트</Text></TouchableHighlight>
                ...
                <ScrollView style={styles.commList} horizontal={true} indicatorStyle = {'white'}>
                       {this.state.commListData.map((prop, key) => {
                         return (
                            <View style={styles.commImg_big}>
                                <Text style={styles.commTitle} numberOfLines={1} key={key}>{prop[1]}</Text>
                            </View>
                         );
                      })}

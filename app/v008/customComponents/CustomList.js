...
export default class CustomList extends Component{
    ...
    render(){
        ...
        return (
            <TouchableHighlight style={styles.listMainContent} 
            onPress={() => {
            this.props.navigation.navigate(this.props.navigateDestination, {
              commId: this.props.commId,
              commName : this.props.commName,
              commCount : this.props.count,
              commDate : this.props.date,
            });
          }}>
                <View>
